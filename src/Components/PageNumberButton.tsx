  ...
  return (
    <div className="inline-flex rounded-xl mt-6">
      <ul className="flex items-center">
        ...
        <li className="px-2">
          <button className="w-9 h-9 rounded-md border hover:border-cyan-500 hover:text-indigo-500">2</button>
        </li>
        <li className="px-2">
          <button className="w-9 h-9 rounded-md border hover:border-cyan-500 hover:text-indigo-500">3</button>
        </li>
        <li className="px-2">
          <button className="w-9 h-9 rounded-md border hover:border-cyan-500 hover:text-indigo-500">4</button>
        </li>
        <li className="px-2">
          <button className="w-9 h-9 rounded-md border hover:border-cyan-500 hover:text-indigo-500">5</button>
        </li>
        <li className="px-2">
          <button
            aria-disabled="false"
