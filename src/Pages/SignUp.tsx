...
const SignUp: React.FC = () => {
  return (
    <div className=" min-h-screen text-gray-900 flex justify-center">
      <div className="m-20  max-w-screen-xl sm-m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          ...
          <div className="mt-5 flex flex-col items-center">
            ...
            <div className="w-full flex-1 mt-8">
              <div className="flex flex-col items-center gap-4">
                <SocailMediaButton svg={googleSvg} text={'구글 회원가입'} />
                <SocailMediaButton svg={gitSvg} text={'카카오 회원가입'} />
              </div>
...
const googleSvg: SVGRectElement = (
