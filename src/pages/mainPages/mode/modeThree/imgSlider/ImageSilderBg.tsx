...
const ImageSilderBg = ({ img }) => {
  return (
    <div className="flex px-6 justify-center bg-white shadow-2xl rounded-xl scale-75">
      <div className="flexflex-col ">
        ...
        <div className="grid grid-cols-3">
          <img
            src={img}
            className="w-[280px] h-[240px] shadow-md overflow-hidden mt-2 bg-gray-300 shrink-0 object-fit rounded-xl"
          />
          <img
            src={img}
            className="w-[280px] h-[240px] shadow-md overflow-hidden mt-2 bg-gray-300  shrink-0 object-fit rounded-xl"
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="flex flex-col shadow-xl m-2 p-2">
            <div className="flex justify-between items-center">
              <h1 className="text-gray-700 font-semibold text-lg">평가 및 리뷰</h1>
          ...
          <div className="flex flex-col shadow-xl m-2 p-2">
            <div className="flex justify-between items-center">
              <h1 className="text-gray-700 font-semibold text-lg p-1">위치 정보</h1>
            </div>
            <iframe
