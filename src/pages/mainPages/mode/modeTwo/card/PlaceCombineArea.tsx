...
const PlaceCombineArea: React.FC = () => {
  ...
  return (
    <div className="flex flex-col m-10 mb-36 w-full h-full justify-center gap-20 items-center">
      {showContent ? (
      ...
      <div className="flex gap-10">
        <ul className="flex gap-3">
          {DUMMY_PLACE.map((place, index) => (
            <li key={index} id={place.id} draggable={true} onDragStart={handleDragStart}>
